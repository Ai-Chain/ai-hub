...
# Copy aihubspawner module to install it
COPY resources/aihubspawner /aihubspawner

RUN \
   pip install --no-cache dockerspawner && \
   pip install --no-cache git+https://github.com/ml-tooling/nativeauthenticator && \
   pip install --no-cache git+https://github.com/jupyterhub/ldapauthenticator && \
   pip install --no-cache git+https://github.com/ryanlovett/imagespawner && \
   pip install --no-cache /aihubspawner && \
   rm -r /aihubspawner && \
...
LABEL \
    ...
    "org.opencontainers.image.documentation"="https://github.com/ai-chain/ai-hub" \
    "org.opencontainers.image.url"="https://github.com/ai-chain/ai-hub" \
    "org.opencontainers.image.source"="https://github.com/ai-chain/ai-hub" \
    ...
    "org.label-schema.usage"="https://github.com/ai-chain/ai-hub" \
    "org.label-schema.url"="https://github.com/ai-chain/ai-hub" \
    "org.label-schema.vcs-url"="https://github.com/ai-chain/ai-hub" \
