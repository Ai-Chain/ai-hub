...
from aihubspawner import utils
...
# Set default environment variables used by our ai-workspace container
...
# --- Spawner-specific ----
c.JupyterHub.spawner_class = 'aihubspawner.MLHubDockerSpawner' # override in your config if you want to have a different spawner. If it is the or inherits from DockerSpawner, the c.DockerSpawner config can have an effect.

c.Spawner.image = "aichain/ai-workspace:0.8.7"
c.Spawner.workspace_images = [c.Spawner.image, "aichain/ai-workspace-gpu:0.8.7", "aichain/ai-workspace-r:0.8.7", "aichain/ai-workspace-spark:0.8.7"]
...
# --- Load user config ---
# Allow passing an additional config upon aihub container startup.
...
if ENV_EXECUTION_MODE == utils.EXECUTION_MODE_KUBERNETES:
    ...
    c.JupyterHub.spawner_class = 'aihubspawner.MLHubKubernetesSpawner'
