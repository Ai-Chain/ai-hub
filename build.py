...
parser.add_argument('--name', help='name of docker container', default="ai-hub")
...
chart_yaml = "./helmchart/aihub/Chart.yaml"
values_yaml = "./helmchart/aihub/values.yaml"
...
try:
    call("helm package ./helmchart/aihub -d helmchart")
except:
